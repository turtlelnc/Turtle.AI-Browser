...
const METHOD_ALIASES: Record<string, string> = {
  ...
  addMcpServer: 'ai.mcp.add',
  removeMcpServer: 'ai.mcp.remove',
  checkMcpServer: 'ai.mcp.check',
  getAiMode: 'ai.mode.get',
  setAiMode: 'ai.mode.set',
  pickWorkdir: 'ai.workdir.pick',
  setWorkdirAllowlist: 'ai.workdir.allowlist',
  aiChat: 'ai.chat',
  aiAgent: 'ai.agent',
  aiAbort: 'ai.abort',
